        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="text-center max-w-3xl mx-auto mt-10">
            ...
            <p className="text-md text-gray-600">
              Our achievements have been highly recognised with around 102+ legal industry awards and nominations in the last 4 years.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-6 bg-white border-y border-gray-100">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            {/* Search bar wrapper */}
            <div className="flex items-center gap-4 p-2 bg-gray-50/50 rounded-full border border-gray-100 shadow-sm">
              {/* Year Filter */}
              <div className="relative group">
                <select
                  ...
                  className="pl-4 pr-10 py-2 bg-white rounded-full text-sm font-medium text-gray-600
                    border border-transparent hover:border-blue-100 focus:border-blue-200
                    focus:outline-none focus:ring-2 focus:ring-blue-50 transition-all duration-200
